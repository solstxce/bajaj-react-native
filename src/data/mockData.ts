...
export const ROLES: Record<RoleId, RoleDef> = {
  ...
  employee: {
    id: "employee", name: "Employee", short: "Regular staff", icon: "fa-user-tie",
    hierarchy: "Employee -> AA/LC -> Branch Manager -> RM", accent: "bg-blue-500",
    pages: [
      { id: "home", label: "Home", icon: "house" },
      { id: "tasks", label: "Tasks", icon: "list-check" },
      { id: "complaints", label: "Issues", icon: "circle-exclamation" },
      { id: "attendance", label: "Attendance", icon: "location-dot" },
      { id: "notifications", label: "Alerts", icon: "bell" },
      { id: "profile", label: "Profile", icon: "id-badge" },
    ],
...
export const users: User[] = [
  ...
  { id: 3, name: "Megha Reddy", role: "employee", branchId: 1, position: "Admin Executive", phone: "99480 11003", email: "megha.reddy@bajaj.com", shift: "09:30 - 18:30", joinDate: "2021-08-17", status: "Present", rating: 4.9, attendancePct: 99, tasksClosed: 418, proofRate: 100, escalations: 0, managerId: 7, salary: 34000, lastCheckIn: "2026-04-26 09:24", skills: ["Reporting", "Vendor follow-up", "Audit prep"], emergencyContact: "Rahul - 98765 11222", documents: ["Aadhaar", "Offer letter", "NDA"], deviceId: "GEO-EMP-2101" },
  { id: 4, name: "Farah Khan", role: "employee", branchId: 2, position: "Operations Executive", phone: "99480 11004", email: "farah.khan@bajaj.com", shift: "09:00 - 18:00", joinDate: "2022-04-11", status: "Present", rating: 4.5, attendancePct: 95, tasksClosed: 289, proofRate: 100, escalations: 2, managerId: 8, salary: 32000, lastCheckIn: "2026-04-26 09:06", skills: ["Cash desk", "MIS", "Customer queue support"], emergencyContact: "Ayaan - 98765 11223", documents: ["Aadhaar", "Offer letter", "Policy sign-off"], deviceId: "GEO-EMP-2202" },
  { id: 5, name: "Lokesh Rao", role: "employee", branchId: 2, position: "Accounts Executive", phone: "99480 11005", email: "lokesh.rao@bajaj.com", shift: "10:00 - 19:00", joinDate: "2020-10-08", status: "Late", rating: 4.3, attendancePct: 92, tasksClosed: 377, proofRate: 100, escalations: 3, managerId: 8, salary: 36000, lastCheckIn: "2026-04-26 10:14", skills: ["Expense validation", "Vendor bills", "Audit notes"], emergencyContact: "Aruna - 98765 11224", documents: ["Aadhaar", "PAN", "Finance SOP acknowledgement"], deviceId: "GEO-EMP-2203" },
...
export const tasks: Task[] = [
  ...
  { id: 103, title: "Consumables stock reconciliation", branchId: 2, audience: "employee", schedule: "Daily", priority: "Medium", zone: "Store room", deadline: "2026-04-26T17:00:00", assignedTo: 4, assignedBy: 8, status: "Pending", checklistDone: 0, checklistTotal: 4, proofRequired: false, completedBy: null, completedAt: null, notes: "Check paper rolls, sanitizer refills and visitor stationery.", escalation: "AA in 4 hrs", proofLabel: "Completion note", redoReason: null },
  { id: 104, title: "Daily cash desk close checklist", branchId: 2, audience: "employee", schedule: "Daily", priority: "High", zone: "Front desk", deadline: "2026-04-26T18:45:00", assignedTo: 4, assignedBy: 8, status: "Revoked", checklistDone: 4, checklistTotal: 4, proofRequired: false, completedBy: 4, completedAt: "2026-04-26T10:02:00", notes: "Branch Manager asked for corrected mismatch in petty cash ledger.", escalation: "Branch Manager if not resubmitted by 15:00", proofLabel: "Completion note", redoReason: "Voucher count mismatch. Re-do with corrected closing slip." },
  ...
  { id: 106, title: "Vendor invoice cross-check", branchId: 1, audience: "employee", schedule: "Weekly", priority: "Medium", zone: "Finance desk", deadline: "2026-04-28T14:00:00", assignedTo: 3, assignedBy: 7, status: "Completed", checklistDone: 5, checklistTotal: 5, proofRequired: false, completedBy: 3, completedAt: "2026-04-25T16:22:00", notes: "Attach mismatch notes for finance audit.", escalation: "Closed", proofLabel: "Review note", redoReason: null },
  ...
  { id: 108, title: "Visitor register digitization", branchId: 2, audience: "employee", schedule: "Weekly", priority: "Low", zone: "Admin bay", deadline: "2026-04-29T15:30:00", assignedTo: 4, assignedBy: 8, status: "In Progress", checklistDone: 2, checklistTotal: 5, proofRequired: false, completedBy: null, completedAt: null, notes: "Digitize pending 3 days and upload note for AA.", escalation: "AA review Friday", proofLabel: "Progress note", redoReason: null },
];

export const complaints: Complaint[] = [
  { id: 201, title: "AC not cooling in customer lounge", branchId: 1, type: "Appliance", priority: "High", status: "Pending", reportedBy: 3, assignedVendor: "Cool Breeze AMC", assetId: 301, estimatedCost: 18500, impact: "Customer wait area temperature above SOP", createdAt: "2026-04-26 09:12", description: "Lounge AC stuck at 28C. Staff moved customers twice already.", escalationStage: "AA", timeline: ["09:12 - Megha raised issue with image proof", "09:18 - Meena acknowledged and assigned quick inspection", "09:36 - Worker reported low gas suspicion"] },
  { id: 202, title: "Washroom plumbing leakage", branchId: 2, type: "Plumbing", priority: "Medium", status: "Escalated", reportedBy: 4, assignedVendor: "AquaFix Services", assetId: 304, estimatedCost: 7600, impact: "Ground floor footfall inconvenience", createdAt: "2026-04-25 15:44", description: "Water drip near ladies washroom utility panel. Needs same-day attention.", escalationStage: "Branch Manager", timeline: ["15:44 - Farah raised issue", "16:02 - Rakesh sent local worker", "17:40 - Needs external vendor due to pipe joint crack"] },
...
export const notifications: NotificationItem[] = [
  ...
  { id: 602, title: "Cash desk close was revoked", detail: "Redo task with corrected voucher slip and comment.", scope: ["employee"], branchId: 2, priority: "High", read: false, bookmarked: true, time: "24 mins ago" },
...
export const currentUserByRole: Record<RoleId, number> = { worker: 1, employee: 4, am: 7, branchManager: 10, rm: 12 };
