    ...
    <View style={{ backgroundColor: colors.card, borderRadius: borderRadius["6xl"], borderWidth: 1, borderColor: colors.border, padding: spacing["2xl"] }}>
      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: spacing.md }}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={{ fontSize: fontSize["2xl"], fontWeight: "800", color: colors.text, marginTop: spacing.sm }}>{branch.name}</Text>
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.lg, marginTop: spacing.xl }}>
        <View style={{ flex: 1, minWidth: 80 }}>
          ...
          <Text style={{ fontSize: fontSize.lg, fontWeight: "700", color: colors.text, marginTop: spacing.xs }}>{branch.todayAttendance}%</Text>
        </View>
        <View style={{ flex: 1, minWidth: 80 }}>
          <Text style={{ fontSize: fontSize.xs, color: colors.textSecondary }}>Open issues</Text>
          <Text style={{ fontSize: fontSize.lg, fontWeight: "700", color: colors.text, marginTop: spacing.xs }}>{branch.openIssues}</Text>
        </View>
        <View style={{ flex: 1, minWidth: 80 }}>
          <Text style={{ fontSize: fontSize.xs, color: colors.textSecondary }}>Budget used</Text>
          <Text style={{ fontSize: fontSize.lg, fontWeight: "700", color: colors.text, marginTop: spacing.xs }}>{budgetPct}%</Text>
        </View>
        <View style={{ flex: 1, minWidth: 80 }}>
          <Text style={{ fontSize: fontSize.xs, color: colors.textSecondary }}>Next visit</Text>
          <Text style={{ fontSize: fontSize.lg, fontWeight: "700", color: colors.text, marginTop: spacing.xs }}>{branch.nextVisit}</Text>
        </View>
        <View style={{ flex: 1, minWidth: 80 }}>
          <Text style={{ fontSize: fontSize.xs, color: colors.textSecondary }}>Audit</Text>
          <Text style={{ fontSize: fontSize.lg, fontWeight: "700", color: colors.text, marginTop: spacing.xs }}>{branch.auditScore}%</Text>
        </View>
      </View>
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.md, marginTop: spacing.xl }}>
        ...
        <View style={{ flex: 1, minWidth: 60, flexDirection: "row", alignItems: "center", gap: spacing.xs }}>
          ...
          <View>
            ...
            <Text style={{ fontSize: fontSize.sm, fontWeight: "600", color: colors.text }}>{branch.staffCount} ({branch.workerCount}W, {branch.employeeCount}E)</Text>
          </View>
        </View>
        <View style={{ flex: 1, minWidth: 60, flexDirection: "row", alignItems: "center", gap: spacing.xs }}>
