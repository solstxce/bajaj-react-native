...
import {
  ...
  AlertTriangle, CheckCircle2, MessageSquare, ArrowUpRight, FileText,
    ...
    <ScreenWrapper>
      ...
      <Card variant="soft" style={{ backgroundColor: colors.text, marginBottom: spacing.xl }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <View style={{ width: 56, height: 56, borderRadius: 28, backgroundColor: complaint.status === "Escalated" ? colors.rose500 + "30" : complaint.status === "Pending" ? colors.amber500 + "30" : colors.emerald500 + "30", alignItems: "center", justifyContent: "center" }}>
            {complaint.status === "Escalated" ? <AlertTriangle size={24} color={colors.rose200} strokeWidth={2} /> : complaint.status === "Pending" ? <Clock size={24} color={colors.amber200} strokeWidth={2} /> : <CheckCircle2 size={24} color={colors.emerald200} strokeWidth={2} />}
          </View>
        </View>
      </Card>
