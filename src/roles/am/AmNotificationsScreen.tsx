...
export function AmNotificationsScreen() {
  ...
  return (
    <ScreenWrapper>
      ...
      <View style={{ gap: spacing.xl, marginTop: spacing.xl }}>
        ...
        {list.length === 0 && (
          <Text style={{ fontSize: fontSize.sm, color: colors.textSecondary, textAlign: "center", paddingVertical: spacing["4xl"] }}>No notifications in this filter</Text>
        )}
      </View>
    </ScreenWrapper>
  );
