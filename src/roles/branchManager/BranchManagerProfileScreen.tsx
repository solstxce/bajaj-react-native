  ...
  return (
    <ScreenWrapper>
      <SectionHeader
        ...
        action={<QuickButton label="Edit profile" onPress={() => showToast("Edit profile coming soon")} />}
      />
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.xl, marginTop: spacing.xl }}>
        ...
        <View style={{ flex: 2, minWidth: 280, gap: spacing.xl }}>
          <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.lg }}>
            <View style={{ flex: 1, minWidth: 90 }}><StatCard label="Attendance" value={currentUser.attendancePct + "%"} meta="Lifetime" accent={colors.success} icon={Award} /></View>
            ...
            <View style={{ flex: 1, minWidth: 90 }}><StatCard label="Rating" value={currentUser.rating.toFixed(1)} meta="Performance" accent={colors.brand} icon={Award} /></View>
          </View>
          ...
          <Card variant="glass">
            ...
            <View style={{ marginTop: spacing.xl, backgroundColor: colors.slate50, borderRadius: borderRadius.xl, padding: spacing.xl }}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.sm, marginBottom: spacing.md }}>
                ...
                <Text style={{ fontSize: fontSize.sm, fontWeight: "600", color: colors.text }}>Documents</Text>
              </View>
            ...
            <View style={{ marginTop: spacing.xl, backgroundColor: colors.brandLight, borderRadius: borderRadius.xl, padding: spacing.xl }}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.sm, marginBottom: spacing.md }}>
                ...
                <Text style={{ fontSize: fontSize.sm, fontWeight: "700", color: colors.brand }}>Managed Branches</Text>
              </View>
              <View style={{ gap: spacing.sm }}>
