...
import { AlertCircle, TrendingUp, CheckCircle2, Send, Search, Calendar } from "lucide-react-native";
  ...
  return (
    <ScreenWrapper>
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.lg, marginTop: spacing.xl }}>
        <View style={{ flex: 1, minWidth: 280 }}><StatCard label="Open" value={String(openCount)} meta="Waiting for action" accent={colors.brand} icon={AlertCircle} /></View>
        <View style={{ flex: 1, minWidth: 280 }}><StatCard label="Escalated" value={String(escalatedCount)} meta="Needs higher approval" accent={colors.error} icon={TrendingUp} /></View>
        <View style={{ flex: 1, minWidth: 280 }}><StatCard label="Resolved" value={String(resolvedCount)} meta="Closed after resolution" accent={colors.success} icon={CheckCircle2} /></View>
      </View>
